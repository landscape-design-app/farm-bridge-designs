---
layout: default
title: "Rebar Cage Construction Booklet - Complete Guide"
...
1. [Introduction & Safety](#introduction)
2. [Tools & Materials](#tools-materials)
3. [Pre-Construction Checklist](#pre-construction)

### SECTION 2: FABRICATION (Days 1-3)
4. [Phase 1: Workspace Setup](#phase-1)
5. [Phase 2: Cutting Plan](#phase-2)
6. [Phase 3: Bending Operations](#phase-3)

### SECTION 3: ASSEMBLY (Days 4-6)
7. [Phase 4: Base Grid Assembly](#phase-4)
8. [Phase 5: Seat Wall Construction](#phase-5)
9. [Phase 6: Parapet Installation](#phase-6)
10. [Phase 7: Bearing Reinforcement](#phase-7)
11. [Phase 8: Wing Assembly](#phase-8)
12. [Phase 9: Special Components](#phase-9)

### SECTION 4: QUALITY & INSPECTION
13. [Quality Control Procedures](#quality-control)
14. [Inspector Requirements](#inspector)
15. [Common Issues & Solutions](#troubleshooting)

### APPENDICES
- [A: Complete Rebar Schedule](#appendix-a)
- [B: Material Quantities](#appendix-b)
- [C: Safety Protocols](#appendix-c)
- [D: Daily Progress Tracking](#appendix-d)
...
## 1.2 TOOLS & MATERIALS {#tools-materials}
...
## 1.3 PRE-CONSTRUCTION CHECKLIST {#pre-construction}
...
## SECTION 2: FABRICATION PHASE {#phase-1}

### PHASE 1: WORKSPACE SETUP (Day 1 Morning) {#phase-1}
...
![Workspace Layout]({{ site.baseurl }}/assets/images/rebar-cage/workspace-layout.png)
...
### PHASE 2: CUTTING OPERATIONS (Days 2-3) {#phase-2}
...
1. **Mark the Bar:**
```
Example: Cutting 3'-0" pieces from 10' bar
...
DO: Clamp firmly within 6" of cut line
DON'T: Cut directly on platform (dulls wheel)
USE: Scrap wood under cut line
```
...
## PHASE 3: BENDING OPERATIONS (Day 3 Afternoon - Day 4) {#phase-3}
...
3. **Apply release agent to NO BOND half:**
   ```
   Materials needed:
   ...
   Process:
   a) Pour oil into shallow pan
   b) Wear gloves
   c) Dip NO BOND half in oil
   d) Let drip, wipe excess
   e) Bar should be slippery but not dripping
   f) DO NOT get oil on BOND half
   ```
...
4. **Wrap NO BOND half:**
   ...
   Wrapping:
   a) Start at center mark
   b) Wrap tightly, overlapping 50%
   c) Continue to end (12" section)
   d) Secure with clear tape
   e) Spray wrapped section with yellow paint
   f) Label "NO BOND" with marker
   g) Let dry
   ```
